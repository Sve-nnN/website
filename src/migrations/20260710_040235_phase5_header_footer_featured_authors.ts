...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_authors_social_links_platform" AS ENUM('linkedin', 'github', 'x', 'website');
  CREATE TYPE "public"."enum_header_nav_items_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_footer_columns_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_footer_social_links_platform" AS ENUM('linkedin', 'github', 'x', 'website');
  ...
  CREATE TABLE "authors_credentials_locales" (
  ...
  CREATE TABLE "featured_content_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  ALTER TABLE "authors" ADD COLUMN "years_experience" numeric;
  ...
  ALTER TABLE "authors_credentials_locales" ADD CONSTRAINT "authors_credentials_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."authors_credentials"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "featured_content_rels" ADD CONSTRAINT "featured_content_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."featured_content"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "featured_content_rels" ADD CONSTRAINT "featured_content_rels_posts_fk" FOREIGN KEY ("posts_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "featured_content_rels" ADD CONSTRAINT "featured_content_rels_case_studies_fk" FOREIGN KEY ("case_studies_id") REFERENCES "public"."case_studies"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "authors_credentials_locales_locale_parent_id_unique" ON "authors_credentials_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX "featured_content_rels_order_idx" ON "featured_content_rels" USING btree ("order");
  CREATE INDEX "featured_content_rels_parent_idx" ON "featured_content_rels" USING btree ("parent_id");
  CREATE INDEX "featured_content_rels_path_idx" ON "featured_content_rels" USING btree ("path");
  CREATE INDEX "featured_content_rels_posts_id_idx" ON "featured_content_rels" USING btree ("posts_id");
  CREATE INDEX "featured_content_rels_case_studies_id_idx" ON "featured_content_rels" USING btree ("case_studies_id");`)
}

export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   DROP TABLE "authors_credentials" CASCADE;
  DROP TABLE "authors_credentials_locales" CASCADE;
  ...
  DROP TABLE "featured_content_rels" CASCADE;
  ALTER TABLE "authors" DROP COLUMN "years_experience";
