import type { BilingualServiceCopy } from './types'

export const fullstackServiceCopy: BilingualServiceCopy = {
  es: {
    slug: 'fullstack-development',
    hero: {
      title: 'Desarrollo Full-Stack con SEO integrado',
      subtitle:
    ...
    includes: {
      title: 'Qué incluye',
      paragraphs: [
        'Desarrollo en Next.js con renderizado en servidor y streaming, pensado para que Google (y cualquier crawler) reciba contenido completo desde la primera respuesta, sin depender de que el JavaScript del cliente termine de ejecutar.',
    ...
    faqs: [
      {
        ...
        answer:
          'Por control real sobre el renderizado: en Next.js decido exactamente qué se sirve al crawler y cuándo, sin depender de que un plugin de caché o un tema de terceros interfiera. Payload permite modelar campos de SEO y datos estructurados directamente en el schema del contenido, en vez de vivir como configuración externa en un plugin que puede desactivarse o romperse en cualquier actualización. El resultado es menos bloat, menos dependencias frágiles, y control total sobre cada aspecto técnico que afecta el posicionamiento.',
      },
      {
  ...
  en: {
    slug: 'fullstack-development',
    hero: {
      title: 'Full-Stack Development with SEO Built In',
      subtitle:
    ...
    includes: {
      ...
      paragraphs: [
        'Next.js development with server rendering and streaming, built so Google (and any crawler) gets full content on the first response, without depending on client-side JavaScript finishing execution.',
...
export const geoServiceCopy: BilingualServiceCopy = {
  es: {
    slug: 'ai-seo-geo',
    hero: {
      title: 'SEO para IA / GEO',
      subtitle:
    ...
    includes: {
      ...
      paragraphs: [
        ...
        'Este mismo sitio ya implementa esta infraestructura: mirá /llms.txt y /llms-full.txt para ver un ejemplo real y funcionando, no una promesa.',
      ],
    },
    process: {
      title: 'Cómo trabajo',
      paragraphs: [
        ...
        'Implemento y mantengo el manifiesto `llms.txt`/`llms-full.txt`, ajustándolo a medida que el sitio agrega contenido nuevo — no es un archivo que se genera una vez y se olvida.',
        'Reviso el marcado semántico y los datos estructurados existentes, ajustándolos para maximizar la probabilidad de que el contenido sea citado, no solo indexado.',
      ],
    },
    faqs: [
      {
      ...
      },
      {
        ...
        answer:
          'Es un campo más nuevo que el SEO tradicional, así que las métricas todavía están madurando. Hoy se puede rastrear si tu marca aparece citada en respuestas de ChatGPT/Perplexity/AI Overviews para consultas relevantes, y monitorear el tráfico referido desde esas plataformas cuando lo reportan. No hay un "ranking" único todavía como en Google, pero sí señales verificables de citación.',
      },
      {
        question: '¿Qué es exactamente el archivo llms.txt?',
        answer:
          'Es un manifiesto de texto plano, pensado para que los agentes de IA entiendan rápidamente de qué trata tu sitio y dónde encontrar el contenido relevante, sin tener que rastrear todo el HTML. Es un estándar emergente (similar en espíritu a robots.txt, pero orientado a IA en vez de crawlers tradicionales). Este sitio ya lo implementa — podés verlo en /llms.txt.',
      },
      {
    ...
    proofLinks: [
      ...
      {
        url: '/llms-full.txt',
        label: 'Ver /llms-full.txt',
        description:
          'La versión extendida del manifiesto, con el detalle completo del contenido del sitio en formato legible por máquina.',
      },
    ],
    ctaText:
      'Si querés que tu contenido empiece a aparecer citado en respuestas de IA en vez de solo en resultados de búsqueda, hablemos de cómo estructurarlo.',
  ...
  en: {
    ...
    process: {
      ...
      paragraphs: [
        ...
        'I review existing semantic markup and structured data, tuning it to maximize the odds of content getting cited, not just indexed.',
      ],
    },
    faqs: [
      {
      ...
      },
      {
        ...
        answer:
          "It's a newer field than traditional SEO, so metrics are still maturing. Today you can track whether your brand gets cited in ChatGPT/Perplexity/AI Overviews responses for relevant queries, and monitor referral traffic from those platforms when they report it. There's no single 'ranking' yet like in Google, but there are verifiable citation signals.",
      },
      {
